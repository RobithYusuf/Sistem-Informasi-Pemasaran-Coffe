...
<title>Read Data Komplain</title>
<!-- style css php -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label>Jenis :<span class="font-weight-bold text text-success"> <?= $row["jenis"]; ?></span></label>
                                </div>
                                <div class="form-group">
                                    <label>Tanggal :<span class="font-weight-bold"> <?= $row["tanggal"]; ?></span></label>
                                </div>
                                <div class="form-group">
                                    <label>Kategori : <span class="font-weight-bold"> <?= $row["kategori"]; ?></span></label>
                                </div>
                                <div class="form-group">
                                    <label>Keterangan : <span class="font-weight-bold text-info"> <?= $row["ket"]; ?></span></label>
                                </div>
                                <br>
                                <a  href="form-komplain.php" class="btn btn-danger pull-left">Kembali</a>
                            </div>
                        </div>        
                    </div>
                </div>
